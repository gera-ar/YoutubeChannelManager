...
addon_info = {
	...
	"addon_name": "YoutubeChannelManager",
...
pythonSources = ["addon/globalPlugins/YoutubeChannelManager/__init__.py", "addon/globalPlugins/YoutubeChannelManager/player.py"]
